 ...
 */
public class ResetEIDPinPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Reset eID Pin", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
        ...
        jButton1.setText("Re-Initialize & Reset eID Pin");
...
//                outputLabel.setFont(new Font("", Font.PLAIN, 16));
            ...
            if (this.cardTerminal != null) {
                ...
                if (this.card != null) {
                    ...
                    if (!this.ngEIDProfile.isInstance()) {
                        ...
                        //Change eIDPin
                        resetEIDPinAsync(ancestorEvent);
    ...
    private void resetEIDPinAsync(AWTEvent event) {
        ...
        JLabel messageLabel = new JLabel("Resetting eID Pin for Card, Please wait...");
    ...
    private void resetEIDPin(){
        ...
        try {
            ...
            try {
                ...
                populateOutputWindow("Change to be made after PUK verification .....", 1);
                ...
                try {
                    ...
                    if (returnMessage.isResult()) {
                        //mn.insertLogs(MainPanel.this.em, "reseteidpin", chipId, "success", "notrequired", Login.user.getUsername(), rt.getMessage(), null);
                        populateOutputWindow("eID Pin Reset successful", 1);
                        utilOps.displayMessage("eID Pin Reset successful", "Success Message", JOptionPane.INFORMATION_MESSAGE);
                        this.processICAMSUpdateRecord(this.entityManager, chipId, AppletTypes.E_ID);
                    } else {
                        populateOutputWindow("eID Pin Reset successful", 1);
                        utilOps.displayMessage("eID Pin Reset failed, please try again.", "Error Message", JOptionPane.ERROR_MESSAGE);
                        //mn.insertLogs(MainPanel.this.em, "reseteidpin", chipId, "failed", "notrequired", Login.user.getUsername(), rt.getMessage(), null);
                    }
        ...
        final Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final WebServiceCommunicator webServiceCommunicator = ResetEIDPinPanel.this.webServiceCommunicator;
                    WebServiceCommunicator.updateICAMS(at, chipId);
                    m.updatePushLog(em, chipId);
                    ResetEIDPinPanel.this.processICAMSUpdate(at);
                }
                catch (Exception ex) {}
            }
        });
