 ...
 */
public class ActivateCardPanel_Copy extends javax.swing.JPanel{
...
//        outputPanelOnScrollPane.setLayout(layout);
    ...
    private void initComponents() {
        ...
        outputPanelOnScrollPane.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Output Window", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        outputPanelOnScrollPane.setMaximumSize(new java.awt.Dimension(100, 95));
        ...
        outputScrollPane.setViewportView(outputPanelOnScrollPane);
        ...
        try{
            ...
            if (this.fingerValue == -1) {
                ...
                try {
                    ...
                    populateOutputWindow("Card activation process initiated....", 1);
                    populateOutputWindow("This process will unblock both eid and epki applet in the card...", 1);
                    populateOutputWindow("Securely retreiving unblocking keys  remotely....", 1);
                    
                    final String chipId = nGeIDCard.readChipId();
                     EIdPin pin = nGeIDCard.getEIdPin();
                     Pin pp =pin.getProfilePin();
                     populateOutputWindow("Max size: " + pp.getMaxSize(), 1);
                     populateOutputWindow("Min size: " + pp.getMinSize(), 1);
                    populateOutputWindow("Chip: " + chipId, 1);
                    populateOutputWindow("EID: " + nGeIDCard.getEIdPin(), 1);
                    populateOutputWindow("PUK: " + nGeIDCard.getEIdPuk(), 1);
                    populateOutputWindow("SOPIN: " + nGeIDCard.getEPkiSoPin(), 1);
                    populateOutputWindow("ePKI USER PIN: " + nGeIDCard.getEPkiUserPin(), 1);
                    populateOutputWindow("Finger Print: " + nGeIDCard.getFingerprints()[0], 1);
                    ...
                    try {
                        try {
                            ...
                            populateOutputWindow("puk: " + rpResponse.getPuk(), 1);
                            populateOutputWindow("sopin: " + rpResponse.getSopin(), 1);
                        ...
                        try {
                            ...
                            populateOutputWindow("Fingerprint verrification successful.", 1);
                        } catch (Exception ex2) {
                            populateOutputWindow("Fingerprint verification failure." + ex2.getMessage(), 0);
                        ...
                        try {
                            ...
                            if (!returnMessage.isResult()) {
                                populateOutputWindow("Unblock Failure: Wrong SOPIN", 0);
                        ...
                        if (returnMessage.isResult()) {
                            ...
                            if (returnMessage.isResult()) {
                                ...
                                populateOutputWindow("Card successfully Activated. You can now unplug the Card.", 1);
        ...
        final Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final WebServiceCommunicator webServiceCommunicator = ActivateCardPanel_Copy.this.webServiceCommunicator;
                    WebServiceCommunicator.updateICAMS(at, chipId);
                    m.updatePushLog(em, chipId);
                    ActivateCardPanel_Copy.this.processICAMSUpdate(at);
                }
                catch (Exception ex) {}
            }
        });
